...
export const EthersProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Example contract address & ABI
  const contractAddress = "0xcD34D12Dd51b2152986bc948141fF05E0189A9ea"; // Replace with actual contract address
  const contractABI = [
    {
      "inputs": [],
...
// Custom hook to use the Ethers context
